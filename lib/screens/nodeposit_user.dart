...
class NoDepositeUser extends StatelessWidget {
  const NoDepositeUser({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      child: ListView(
        ...
        children: [
          Center(child: SpentCard(title: "Total Spents", amount: 5237, widthPercentage: 0.5,)),
          SizedBox(height: 20,),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              SpentCard(title: "Yours Spends", amount: 1135, widthPercentage: 0.27, titleColor: Colors.grey,),
              SizedBox(width: 10,),
              SpentCard(title: "Your Gains ", amount: 1135, widthPercentage: 0.27, amountColor: Colors.green,titleColor: Colors.grey,),
              SizedBox(width: 10,),
              SpentCard(title: "Your Losses ", amount: 1135, widthPercentage: 0.27, amountColor: Colors.red,titleColor: Colors.grey,),
            ],
          ),
          SizedBox(height: 40,),
          Column(
