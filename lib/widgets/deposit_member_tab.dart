    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          if ((admin && widget.room['Members yet to Contribute'].length != 0) ||
              (!admin &&
                  widget.room['Members yet to Contribute']
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: TextInter(
                      title: widget.room['personalBalance'][member].toString(),
                      color: widget.room['personalBalance'][member] > 0
                          ? appColors.profit
                          : appColors.loss,
                      alignment: TextAlign.right),
                ),
